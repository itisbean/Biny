...
<div class="mume markdown-preview" style="height: 800px;width:80%;margin:0 auto;">
    <p class="list-p">
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#addBdModal">Add</button>
    </p>
    <hr>
        ...
        <tbody>
            <?php foreach ($data as $val) : ?>
                <tr>
                    ...
                    <td><?php echo $val['under_floors']; ?></td>
                    <td><?php echo $val['ground_floors']; ?></td>
                    <td><?php echo $val['remark']; ?></td>
                    <td>
                        <button type="button" class="btn btn-info" data-toggle="modal" onclick="return get_edit_info(<?php echo $val['id']; ?>)" data-target="#addBdModal">Edit</button>
                        <button type="button" class="btn btn-danger" onclick="return delete_info(<?php echo $val['id']; ?>)">Delete</button>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
...
<form method="post" action="" class="form-horizontal" role="form" id="form_data" onsubmit="return check_form()" style="margin: 20px;">
    <div class="modal fade" id="addBdModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name" value="{name}" placeholder="请输入建筑名称">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="lastname" class="col-sm-3 control-label">Tel</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="tel" value="" placeholder="联系电话">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="lastname" class="col-sm-3 control-label">Address</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="address" value="" placeholder="地址">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="remark" value="{remark}" placeholder="备注">
...
<script src="<?= $webRoot ?>/static/js/sample-geojson.js" type="text/javascript"></script>
